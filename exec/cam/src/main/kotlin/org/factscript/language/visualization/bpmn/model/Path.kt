...
import org.factscript.language.execution.cam.EngineTransitionListener
 ...
 */
class Path(val from: Element<out Node,*>, private val to: Element<out Node, *>, parent: Group<*>, val conditional: ConditionalNode?): Element<Node, SequenceFlow>(to.node, parent) {
    ...
    override fun initModel() {
        ...
        with(conditional) {
            ...
            if (this != null) {
                ...
                model.name = if (parent is RepeatingFlow) (if (condition != null) "Yes" else "No") else description.asLines()
