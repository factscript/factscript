...
open class Artefact(private val inner: Dimension, private val margin: Dimension): Box() {
    ...
    override val east: Position get() = Position(innerDimension().width, innerDimension().height / 2)
    override val north: Position get() = Position(innerDimension().width / 2, 0)
    override val south: Position get() = Position(innerDimension().width / 2, innerDimension().height)
