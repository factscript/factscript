...
import io.factdriven.language.FlowImpl
...
object Flows {
    ...
    private val flows: MutableMap<KClass<*>, io.factdriven.definition.api.Flow> = mutableMapOf()

    fun initialize(type: KClass<*>, vararg types: KClass<*>): List<io.factdriven.definition.api.Flow> {
    ...
    fun get(id: String): io.factdriven.definition.api.Flow {
        return get(Type(id.split("-")[0], id.split("-")[1]))
    }

    fun get(type: Type): io.factdriven.definition.api.Flow {
    ...
    fun get(type: KClass<*>? = null, handling: KClass<*>? = null): io.factdriven.definition.api.Flow {
    ...
    fun all(): Iterable<io.factdriven.definition.api.Flow> {
