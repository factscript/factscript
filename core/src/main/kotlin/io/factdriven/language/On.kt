...
import io.factdriven.definition.impl.PromisingImpl
...
class OnImpl<T: Any>(parent: Executing): On<T>, Promise<T>, OnCommandPromise<T>, PromiseReport<T>, PromisingImpl(parent) {
